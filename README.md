...
This is a fork of [the original gulp-sass](https://github.com/dlmanning/gulp-sass) package where the Node Sass version has been updated.

If you need a newer version, feel free to submit a PR.
